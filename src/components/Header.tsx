...
const Header: FC = () => {
  ...
  return (
    <HStack p={4} bg='heading.bg' color='heading.fg' w='100%' height='48px'>
        ...
        <Link href='https://www.apollographql.com' target='_blank'>
          <Icon asChild w={8} h={8} fill='heading.fg' p='1px'>
            <svg fill='currentcolor' viewBox='0 0 200 200'>
              <path
                d='M112.246 49H88.003L53 139.848h21.927l5.721-15.393h33.076l-5.989-17.024H85.961l14.164-39.091 25.199 71.508h21.928z'></path>
              <path
      ...
      <Box flex={1}/>
      <Link href='https://www.apollographql.com/docs/graphos/schema-design/connectors'
            colorPalette='brand'
            target='_blank'
            color='heading.fg'
      >
